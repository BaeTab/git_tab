...
public sealed partial class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> Ko = new(StringComparer.Ordinal)
    {
        ...
        ["Settings.AccentColor.Tip"] = "버튼과 강조 요소에 쓰이는 색이에요. ‘테마’로 두면 현재 테마의 기본 강조색을 쓰고, #RRGGBB 형식으로 직접 입력할 수도 있어요.",
        ["Settings.AccentDefault"] = "테마",
        ["Settings.UiFont"] = "UI 글꼴",
        ["Settings.DiffFont"] = "Diff 글꼴",
        ["Settings.DiffFontSize"] = "Diff 글자 크기",
        ["Settings.GraphDensity"] = "그래프 밀도",
        ["Settings.GraphGlow"] = "그래프 발광 효과",
        ["Settings.Density.Compact"] = "촘촘하게",
        ["Settings.Density.Normal"] = "보통",
        ["Settings.Density.Comfortable"] = "널찍하게",
        ["Settings.DiffSplitDefault"] = "기본으로 좌우 비교 보기",
        ["Settings.DiffContext"] = "문맥 줄 수",
        ["Settings.DiffWordWrap"] = "긴 줄 자동 줄바꿈",
        ["Settings.FetchInterval"] = "자동 확인 주기",
        ["Settings.ReopenLast"] = "시작할 때 마지막 저장소 다시 열기",
        ["Settings.AbsoluteDates"] = "절대 날짜로 표시",
    ...
    private static readonly Dictionary<string, string> En = new(StringComparer.Ordinal)
    {
        ...
        ["Settings.AccentColor.Tip"] = "The color used for buttons and highlights. Leave it on \"Theme\" to use the current theme's own accent, or enter a custom #RRGGBB value.",
        ["Settings.AccentDefault"] = "Theme",
        ["Settings.UiFont"] = "UI font",
        ["Settings.DiffFont"] = "Diff font",
        ["Settings.DiffFontSize"] = "Diff font size",
        ["Settings.GraphDensity"] = "Graph density",
        ["Settings.GraphGlow"] = "Glowing graph lanes",
        ["Settings.Density.Compact"] = "Compact",
        ["Settings.Density.Normal"] = "Normal",
        ["Settings.Density.Comfortable"] = "Comfortable",
        ["Settings.DiffSplitDefault"] = "Split view by default",
        ["Settings.DiffContext"] = "Context lines",
        ["Settings.DiffWordWrap"] = "Wrap long lines",
        ["Settings.FetchInterval"] = "Auto-check interval",
        ["Settings.ReopenLast"] = "Reopen the last repository on startup",
        ["Settings.AbsoluteDates"] = "Show absolute dates",
