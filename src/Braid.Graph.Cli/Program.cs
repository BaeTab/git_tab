using System.Text;
using Braid.Core.Git;
using Braid.Graph;
using Braid.Graph.Cli;
using Braid.Graph.Models;
...
//   usage: Braid.Graph.Cli [repoPath] [maxCommits]
...
Console.WriteLine($"# Braid GraphLayoutEngine — {discovered}");
